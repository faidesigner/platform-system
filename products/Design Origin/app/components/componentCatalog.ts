...
export const componentProperties: Record<string, ComponentProperty[]> = {
  ...
  Drawer: [{ name: "isOpen", type: "boolean", required: true, description: "드로어 열림 상태입니다." }, { name: "onClose", type: "() => void", required: true, description: "닫기 이벤트입니다." }, { name: "children", type: "ReactNode", required: true, description: "드로어 내부 콘텐츠입니다." }, { name: "scope", type: '"viewport" | "container"', defaultValue: '"viewport"', description: "전체 viewport 또는 부모 컨테이너 안에 드로어를 띄웁니다." }],
  ...
  ScrollTopButton: [{ name: "scrollTarget", type: "HTMLElement | RefObject<HTMLElement | null>", description: "전달하면 window 대신 해당 요소의 스크롤을 감지합니다." }, { name: "threshold", type: "number", defaultValue: "300", description: "버튼이 나타나는 스크롤 위치 기준입니다." }],
