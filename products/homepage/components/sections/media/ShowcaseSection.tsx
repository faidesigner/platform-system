...
function YoutubeCard({ channelLabel, ctaLabel, videos, a11y }: YoutubeCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 min-w-0 items-center bg-fill-faint p-[var(--padding-2-xl,32px)] max-[961px]:order-2 max-[961px]:flex-none max-[961px]:min-h-[320px] max-[421px]:p-[var(--padding-XL)]">
        <div className="flex flex-col justify-between items-start flex-1 self-stretch">
          ...
          <div className="flex w-full items-start justify-between self-stretch">
            ...
            {videos.length > 1 && (
              <div className="flex items-start justify-end gap-ms max-[961px]:hidden">
                <IconButton
                  variant="assistive"
                  size="M"
